<article id="speakers">
  ...
  <h2><span>The Speakers</span></h2>
 
  <ul>
    <li class="box" id="alex">
      <h3><span><em>Alex Russell</em></span> <a href="http://twitter.com/slightlylate">@slightlylate</a></h3>
