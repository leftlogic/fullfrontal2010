...
<article class="box" id="venueDetails">
  <section class="details">
    ...
    <h4>By Car</h4>
    <p>Head down the A23 if coming from north or A27 from east/west.</p>

    <h4>By Train</h4>
    <p>Get the train to Brighton, 15 minute walk from there.</p>

    <h4>By Plane</h4>
    <p>Fly to London Gatwick and get the train to Brighton.</p>
...
<article class="box" id="venueHotels">
 
  <section class="details">
 
    <h3><span>Hotels nearby</span></h3>
...
<article class="box" id="venueFood">
 
  <section class="details">
   
    <h3><span>Places to eat nearby</span></h3>
...
<article class="box" id="afterParty">
